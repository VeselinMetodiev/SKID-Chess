...
set transPieces(F)   { P P K R Q D R T B O N K }
set untransPieces(F) { P P R K D Q T R O B K N }
...
set transPieces(C)   { P B K K Q D R T B L N S }
set untransPieces(C) { B P K K D Q T R L B S N }
## TODO Put in the right letters for greek
set transPieces(P)   { P P K R Q D R T B A N C }
set untransPieces(P) { P P R K D Q T R A B C N }
...
addLanguage B Bulgarian 0 utf-8 bulgarian.tcl
...
addLanguage Z {Brazil Portuguese} 0 iso8859-1 portbr.tcl
